...
return {
	...
	Description = "A Command."; -- The description of the command.
	Arguments = {}; -- Which arguments are expected.
	Keys = { 
	...
	Visible = false; -- Is the command visible for those who can't use it?
	...
	OnRun = function(env, Executor:Player, Arguments:{[string|number]:any?}, Keys:{[string]:any?})
